  ...
  if (error) {
    return (
      <main className="min-h-screen bg-stone-50 px-3 py-8 text-zinc-900 xl:px-6">
        <p className="text-red-700">Ошибка загрузки: {error.message}</p>
      </main>
    );
  }
    ...
    <main className="min-h-screen bg-stone-50 px-3 py-8 text-zinc-900 xl:px-6">
      <section className="mx-auto max-w-[1800px]">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold">Таблица заявок</h1>
            <p className="mt-2 text-zinc-600">
              Компактный режим для большого количества заявок.
            </p>
          </div>
